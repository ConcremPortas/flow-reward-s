...
export function EpiHeader({ children }: Props) {
  return (
    <div className="rounded-2xl border border-border/70 bg-card px-5 py-4 shadow-[var(--shadow-card)]">
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold leading-tight tracking-tight text-foreground">Gestão de EPI</h1>
            <p className="text-xs text-muted-foreground">Auditoria e conformidade de equipamentos de proteção individual</p>
          </div>
        </div>
