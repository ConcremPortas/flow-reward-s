...
export function SectorIndicatorsSaveBar({ setoresAlterados, indicadoresAlterados, saving, onDiscard, onReview }: Props) {
  ...
  return (
    <div className="sticky bottom-4 z-20 flex flex-wrap items-center gap-4 rounded-2xl border border-status-warning/30 bg-card px-5 py-3.5 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.25)]">
      ...
      <div className="hidden items-center gap-3 text-xs text-muted-foreground sm:flex">
        <span>{pluralizeBR(indicadoresAlterados, 'indicador modificado', 'indicadores modificados')}</span>
      </div>
