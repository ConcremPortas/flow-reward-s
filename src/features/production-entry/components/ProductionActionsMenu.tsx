...
export function ProductionActionsMenu({ setorNome, competenciaLabel, onView, onEdit, onViewIndicators, onDelete }: Props) {
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuItem onClick={onViewIndicators}><BarChart3 className="mr-2 h-4 w-4" /> Ver indicadores do setor</DropdownMenuItem>
      ...
      <AlertDialog open={confirmOpen} onOpenChange={(o) => { if (!deleting) setConfirmOpen(o); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Excluir registro de produção</AlertDialogTitle>
            <AlertDialogDescription>
              Excluir o registro de <strong>{setorNome}</strong> em <strong>{competenciaLabel}</strong> remove o dado
